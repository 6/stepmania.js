...
declare function context(description: string, specDefinitions: () => void): void;
declare function ccontext(description: string, specDefinitions: () => void): void;
declare function xcontext(description: string, specDefinitions: () => void): void;
